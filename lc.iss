...
#define MyAppExeName "launch_browser.bat"
...
OutputBaseFilename=lc_setup_3_0_2
...
[Icons]
Name: "{commonprograms}\{#MyAppName}"; Filename: "{app}\resources\{#MyAppExeName}"; IconFilename: "{app}\resources\{#MyAppIcon}"
...
Filename: "{app}\resources\{#NSSM}"; Parameters: "remove {#MyAppName} confirm"; Flags: runhidden;
Filename: "{sys}\net.exe"; Parameters: "stop {#MyAppName}"; Flags: runhidden;
